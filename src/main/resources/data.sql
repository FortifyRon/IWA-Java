...
INSERT INTO users (id, username, password, first_name, last_name, email, phone, address, city, state, zip, country, date_created, gender, enabled)
VALUES ('f3a7d2e1-9c4b-4f8a-b6e5-2d1c3f5a7b9e', 'user3', '$2a$10$YFhTnHpCL.Z0Ev0j1CbEUub7sIWmN7Qd5RmnU8g5ekuoapV7Zdx32',
        'Bob', 'Shopper', 'user3@localhost.com', '0123456789', '1 Somewhere Street', 'London', 'Greater London', 'SW1', 'United Kingdom', CURDATE(), 'Male', 1);
